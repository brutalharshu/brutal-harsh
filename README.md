...
I'm a 19-year-old aspiring website developer, Android app developer, and freelancer. I'm currently pursuing a BCA degree to expand my technical knowledge and skills.
...
* Made software & tools for NFT
* Made software & tools for sellers
* Made software & tools to do work fast

**WEB DESIGNER AND DEVELOPER**

* HTML, CSS, JavaScript, and Next.js
* Developed custom websites for various companies
* Designed super cool animated websites for clients
* Designed e-commerce, portfolios, and blogs websites
...
* Web development frameworks: Next.js
* Software development tools: Git, GitHub, Visual Studio Code
* Cloud computing platforms: AWS, Azure, GCP

![Total Repositories](https://img.shields.io/badge/Total%20Repositories-https://github.com/Jod-Harsh?tab=repositories-brightgreen)
